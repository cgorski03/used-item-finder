/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d131ecfdf76805b8a42dfea723e9c741)
...
declare namespace Cloudflare {
    ...
    interface Env {
        AUTH_TOKEN_KV: KVNamespace;
        DATABASE_URL: "placeholder" | "postgres://colin:secure_password@localhost:5432/itemfinder" | "postgres://colin:secure_password@localhost:5432/itemfinder_test";
        EBAY_KV_KEY: "placeholder" | "EBAY_AUTH";
        EBAY_ENV: "SANDBOX" | "PRODUCTION";
        EBAY_CLIENT_ID: string;
        EBAY_DEV_ID: string;
        EBAY_CLIENT_SECRET: string;
        GOOGLE_API_KEY: string;
        SEARCH_RUN_QUEUE: Queue;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "EBAY_KV_KEY" | "EBAY_ENV" | "EBAY_CLIENT_ID" | "EBAY_DEV_ID" | "EBAY_CLIENT_SECRET" | "GOOGLE_API_KEY">> { }
}
